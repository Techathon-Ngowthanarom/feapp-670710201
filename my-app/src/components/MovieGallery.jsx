...
function MovieGallery() {
  ...
  return (
    <div className="mx-auto max-w-md rounded-2xl bg-white p-6 shadow-md">
        <img src={movie.poster} alt={movie.title} className="rounded-lg mx-auto h-100 w-full object-cover" />
      <button onClick={handleNextClick}
              className="rounded-lg bg-cyan-600 mt-4 px-4 py-2 font-semibold text-white">
        เรื่องถัดไป
      </button>
